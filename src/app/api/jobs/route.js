...
export async function POST(request) {
  try {
    ...
    const job = {
      name,email,company,jobTitle,location,jobType,category,salaryRange,experience,deadline,applyLink,website,description,responsibilities,requirements,perks,postedAt: new Date(),
    };
